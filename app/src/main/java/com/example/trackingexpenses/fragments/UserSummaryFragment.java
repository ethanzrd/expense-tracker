...
public class UserSummaryFragment extends Fragment {
    ...
    public static UserSummaryFragment newInstance(String userId) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        incomeValueTextView = view.findViewById(R.id.incomeValueTextView);
        expenseValueTextView = view.findViewById(R.id.expenseValueTextView);
        balanceValueTextView = view.findViewById(R.id.balanceValueTextView);
        ...
        // Setup RecyclerView
        categoryBreakdownRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        
        // Initialize adapters
        incomeSummaryAdapter = new CategorySummaryAdapter(getContext(), true);
        expenseSummaryAdapter = new CategorySummaryAdapter(getContext(), false);
    ...
    /**
     * Loads user financial summary for the selected month
     */
    private void loadUserSummary() {
        ...
        // Get the year and month from selected date
        ...
        mDatabase.child("entries").child(userId).orderByChild("date")
